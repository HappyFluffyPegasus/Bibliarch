...
import { Plus, Minus, Maximize2, MousePointer, Hand, Type, Folder, User, MapPin, Calendar, Trash2, Undo, Redo, X, List, Move, Image } from 'lucide-react'
  ...
  const handleNodeDoubleClick = (node: Node) => {
    ...
    if (node.type === 'folder') {
      if (node.linkedCanvasId && onNavigateToCanvas) {
        ...
        console.log('DEBUG: Creating new canvas for folder:', node.id)
      ...
      console.log('DEBUG: Not a folder node, skipping navigation')
    }
  }
