...
export class PaletteGenerator {
  static generateFromTemplate(template: ColorTemplate, theme: 'light' | 'dark', scope: 'global' | 'project' | 'folder' = 'global'): ColorPalette {
    ...
    // 3-color system: light blue main, dark purplish-blue complementary, yellow accent
    const mainColor = ColorUtils.hslToHex(baseHue, saturation, lightness)           // Light blue main color
    ...
    const accentColor = ColorUtils.hslToHex(accentHue, 80, 60)                     // Yellow accent color
    ...
    if (theme === 'light') {
      return {
        ...
        scope,
        colors: {
          // Light theme: Main color for nodes, complementary for text, accent for background
          primary: ColorUtils.hslToHex(baseHue, saturation * 0.2, 95),      // Very light main color
          primaryText: complementaryColor,                                   // Complementary for text
          secondary: ColorUtils.hslToHex(baseHue, saturation * 0.3, 90),    // Light main variation
          accent: accentColor,                                               // Accent color
          
          border: complementaryColor,                                        // Complementary for borders
          hover: ColorUtils.hslToHex(baseHue, saturation * 0.4, 85),        // Slightly darker main
          selected: ColorUtils.hslToHex(baseHue, saturation * 0.6, 80),     // More saturated main
          
          canvasBackground: ColorUtils.hslToHex(accentHue, 60, 85),         // More visible accent for background
          nodeDefault: mainColor,                                            // Light blue main color for nodes
      ...
      return {
        ...
        colors: {
          ...
          canvasBackground: accentColor,                                          // Same accent for background
          nodeDefault: complementaryColor,                                        // Swapped: complementary for nodes  
          nodeText: mainColor,                                                    // Swapped: main for text
          connectionDefault: mainColor,                                           // Light main for connections
