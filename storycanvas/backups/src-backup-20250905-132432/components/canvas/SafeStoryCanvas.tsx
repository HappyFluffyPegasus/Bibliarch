...
interface SafeStoryCanvasProps {
  storyId: string
  initialNodes?: Node[]
...
export default function SafeStoryCanvas(props: SafeStoryCanvasProps) {
  ...
  // Always use HTML Canvas to avoid Jest worker issues
  // Dynamically import the HTML canvas component
